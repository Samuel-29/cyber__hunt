...
export const TestRules = () => {
  return (
    ...
    <h2>Rules: </h2>
    <ul>
      <li>The game consists of a set of questions related to cyber security.</li>
      ...
      <li>You can take the test only one times. until/unless you reach the solution end successfully.</li>
